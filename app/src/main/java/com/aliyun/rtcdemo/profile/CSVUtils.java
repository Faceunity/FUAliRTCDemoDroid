package com.aliyun.rtcdemo.profile;
...
public class CSVUtils {
    ...
    public void writeData(double fps, long renderTime) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                mCpuUsed = mCPUInfoUtil.getProcessCpuUsed();
                ...
                stringBuilder.append(dateFormat.format(new Date(mTimestamp))).append(COMMA)
                        .append(String.format(Locale.getDefault(), "%.2f", fps)).append(COMMA)
                        .append(String.format(Locale.getDefault(), "%d", renderTime)).append(COMMA)
                        .append(strCPU).append(COMMA)
                        .append(strMemory).append(COMMA);
